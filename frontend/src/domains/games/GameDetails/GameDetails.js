...
import { isOnWishlist, isAlreadyPlayed, toggleOnWishlist, toggleOnPlayedGamesList } from '../../../services/userClient'
    ...
    <>
      <StyledIcons>
        ...
        <Icon id="played-icon" 
          ...
          onClick={() => toggleOnPlayedGamesList(game._id).then(setAlreadyPlayed)} />
        </StyledIcons>
      <StyledImage>
...
const BggRatingStar = ({ rating, size = 64 }) => (
  <StyledBggRatingStar style={{ width: size + 'px', height: size+'px', marginTop:(-5/8*size)+'px'}}>
