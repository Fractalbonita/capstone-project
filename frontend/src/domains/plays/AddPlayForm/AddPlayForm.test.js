...
describe('AddPlayForm', () => {
  ...
  test('should render heading', async () => {
    ...
    expect(
      queryByText(container, 'Add a New Play to your Timeline')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when game title is too long', async () => {
    ...
    expect(
      getByText(container, 'The title of the game is too long.')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when no player is entered', async () => {
    ...
    expect(
      getByText(container.querySelector('[id="players-0-name"]'), 'Required')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when the name of the player is too short', async () => {
    ...
    expect(
      getByText(container, 'The name should be at least 2 characters.')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when the name of the player is too long', async () => {
    ...
    expect(
      getByText(container, 'The name should be maximum 20 characters.')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when playing time is written with alphabetic characters', async () => {
    ...
    expect(
      getByText(container, 'Please mind that only numbers are allowed.')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when playing time is a floating number', async () => {
    ...
    expect(
      getByText(container, 'The playing time must be an integer number.')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when playing time is a negative number', async () => {
    ...
    expect(
      getByText(container, 'The playing time must be a positive number.')
    ).toBeTruthy()
  })
  ...
  test('should prohibit submit when playing time is a negative number', async () => {
    ...
    expect(
      getByText(
        container,
        'Congrats! You played so many hours. The maximum is 720.'
      )
    ).toBeTruthy()
  })
    ...
    await wait(() => {
      fireEvent.click(
        container.querySelector(
          `.material-icons.star:nth-of-type(${insertPlayRating})`
        )
      )
    })
